...
function context() {
	...
	var createpattern = function(x,y) {
		...
		if (!checkcollisionquadtree(quadtree,newnodes[0],0.001) && !checkcollisionquadtree(quadtree,newnodes[1],0.001)) {
			...
			var framecircle = new Circle(0.0,0.0,1000.0);
			var framecenters = circlepoints(framecircle,4000,0.0);
			...
			for (var incircle = 0; incircle < niter-noffset; incircle++) {
				...
				var rsupport = samples(1.0,4.0,ncircle*2);
	...
	viewbox0 = mergeviewboxes(circleviewbox(new Circle(0.0,0.0,1000.0)),circleviewbox(new Circle(2.0,3.0,1.0)));
	...
	function iterframe() {
		...
		var viewviewbox = squareviewbox(expandviewbox(viewbox0,1.0));
		
		// viewviewbox = [-3000.0,-3000.0,3000.0,3000.0];
