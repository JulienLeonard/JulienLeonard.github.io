...
function circles2tangent(c1,type1,c2,type2,radius,side) {
    // console.log("circles2tangent",c1,c2,radius,side);
    var x1 = c1.x, y1 = c1.y, r1 = c1.r;
    var x2 = c2.x, y2 = c2.y ,r2 = c2.r;
...
// var iminsqrt = 100000.0;
// var imaxsqrt = 0.0;

function circles2tangentoptim(c1,c2,radius,side) {
    // console.log("circles2tangent",c1,c2,radius,side);
    var x1 = c1.x, y1 = c1.y, r1 = c1.r;
    var x2 = c2.x, y2 = c2.y ,r2 = c2.r;
    ...
    var s3x = x1-x2;
    var s3y = y1-y2;
    var isqrt = s3x*s3x + s3y*s3y;
    var l3 = Math.sqrt(isqrt );

    // if (iminsqrt > isqrt) {
    // 	iminsqrt = isqrt;
    // 	console.log("iminsqrt",iminsqrt,"imaxsqrt",imaxsqrt);
    // }
    // if (imaxsqrt < isqrt) {
    // 	imaxsqrt = isqrt;
    // 	console.log("iminsqrt",iminsqrt,"imaxsqrt",imaxsqrt);
    ...
    var sinv = Math.sqrt(1.0 - cosv * cosv) * side;
    var news3x = cosv * s3x - sinv * s3y;
    var news3y = sinv * s3x + cosv * s3y;
    var newx = x2 + news3x * l2 / l3;
    var newy = y2 + news3y * l2 / l3;
...
function checkcollisionquadtree(tree,c) {
    ...
    return tree.iscollidingoptim(c);
}
...
// function expansion2(xmin xmax minsize input) {
//     var result = [];
// }
