...
function context () {
	...
	// var radiuss = [1.0,1.01,1.02,1.01,1.0,0.99,1.0];
	...
	var ncolors = [ncolor1,ncolor2,ncolor3,ncolor2,ncolor1,ncolor3];
			...
			for (isubiter = 0; isubiter < 100;isubiter++) {
				...
				if (newnode.x != NaN) {
					if (!checkcollisionquadtree(quadtree,newnode)) {
						...
						drawcircle(canvas,newnode,d3.hsl((newnode.r-0.9)*360.0, 1, 0.5));
